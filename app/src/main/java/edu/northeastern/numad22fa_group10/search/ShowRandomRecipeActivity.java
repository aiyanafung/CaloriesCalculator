...
public class ShowRandomRecipeActivity extends AppCompatActivity {
    private static final String TAG = "ShowRandomRecipeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_random_recipe);
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    URL url = new URL("https://api.spoonacular.com/recipes/random?" +
                            "apiKey=" + apiKey);
                    ...
                    // get summary from recipes/summary
                    JSONArray recipes = (JSONArray)jObject.get("recipes");
                    JSONObject recipe1 = (JSONObject) recipes.get(0);

                    recipeSummary = String.valueOf(recipe1.get("summary"));;
                    recipeWebsite = String.valueOf(recipe1.get("spoonacularSourceUrl"));;
